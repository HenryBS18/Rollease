                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Image.asset(
                                          (state is SelectedVehicle)
                                              ? (state.vehicle.type == "Scooter" ? 'assets/25.png' : 'assets/102.png')
                                              : 'assets/102.png',
                                          fit: BoxFit.contain,
                                        ),
                                      ),
                                      ...
                                      Text(
                                        (state is SelectedVehicle) ? state.vehicle.name : "",
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "${(state is SelectedVehicle) ? state.vehicle.battery : ""}%",
