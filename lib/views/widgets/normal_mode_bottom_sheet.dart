...
class _NormalModeBottomSheetState extends State<NormalModeBottomSheet> {
  ...
  int getTotalVehicle({required String type}) {
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            widget.stationList[widget.currentIndex].place,
                                            style: const TextStyle(
                                              fontSize: 14,
                                              color: Colors.black,
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                const SizedBox(height: 8),
                                                Text(
                                                  "${getTotalVehicle(type: "Scooter")} Scooter",
                                                  style: const TextStyle(
                                                    fontWeight: FontWeight.bold,
                                                  ),
                                                ),
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                const SizedBox(height: 8),
                                                Text(
                                                  "${getTotalVehicle(type: "Bike")} Bike",
                                                  style: const TextStyle(
                                                    fontWeight: FontWeight.bold,
                                                  ),
                                                ),
                              ...
                              return Row(
                                children: [
                                  GestureDetector(
                                    onTap: () {
                                      setState(() {
                                        int id = availableVehicleList[index].id;
                                        context.read<SelectedVehicleBloc>().add(SetSelectedVehicleEvent(id));
                                      });
                                    },
                                    child: VehicleInfoCard(vehicle: vehicle),
                                  ),
                                  index != availableVehicleList.length - 1 ? const SizedBox(width: 16) : const SizedBox(),
                                ],
                              );
                            },
                          ),
